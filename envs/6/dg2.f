...
c
c      For iniital dinsity profile of an exponential gas disk 
c      For the MW (outer gas disk).
c
c     New version* reading dg2.para
c     program name: dg2.f
c
c
cccccccccccccccccccccccccccccccccccccccccccccccccccccccc
